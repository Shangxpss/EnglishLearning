...
class SubtitleProcessor:
    ...
    def generate_subtitles(self, audio_path: str, language: str = "en", model_size: str = "medium.en", task: str = "transcribe") -> List[Dict[str, Any]]:
        """
        ...
        Args:
            ...
            model_size: Whisper model size (e.g., "base.en", "small", "medium")
    ...
    def generate_srt_subtitles(self, audio_path: str, output_path: str, language: str = "en", model_size: str = "medium.en", task: str = "transcribe"):
        """
        Generate SRT subtitle file
        """
        try:
            subtitles = self.generate_subtitles(
                audio_path, language, model_size, task)
